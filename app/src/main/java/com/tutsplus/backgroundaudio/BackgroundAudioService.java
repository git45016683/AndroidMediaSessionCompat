...
//    };
    ...
    private MediaSessionCompat.Callback mMediaSessionCallback = new MediaSessionCompat.Callback() {
        ...
        public boolean onMediaButtonEvent(Intent mediaButtonEvent) {
            Log.v("TTTTTTTTTTTTTT", mediaButtonEvent.getAction());
            Log.v("TTTTTTTTTTTTTT", mediaButtonEvent.getParcelableExtra(Intent.EXTRA_KEY_EVENT).toString());
            return super.onMediaButtonEvent(mediaButtonEvent);
        }

        @Override
        public void onPlay() {
            Log.v("TTTTTTTTTTTTTT", "onPlay");
            super.onPlay();
